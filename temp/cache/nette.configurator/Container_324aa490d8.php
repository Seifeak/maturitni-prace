<?php
// source: /var/www/mp/config/common.neon
// source: /var/www/mp/config/services.neon
// source: array
...
class Container_324aa490d8 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Model\BookApiService' => [['02']],
		'App\Model\FileManager' => [['03']],
	...
	public function createService02(): App\Model\BookApiService
	{
		return new App\Model\BookApiService('AIzaSyCK7ZVlj0v-UpXmwBNtTw4TPzljvNKUnnw', '/var/www/mp/www');
	}


	public function createService03(): App\Model\FileManager
	{
		return new App\Model\FileManager('/var/www/mp/www', 'AIzaSyCK7ZVlj0v-UpXmwBNtTw4TPzljvNKUnnw');
	}


	public function createServiceApplication__1(): App\UI\Categories\CategoriesPresenter
	{
		$service = new App\UI\Categories\CategoriesPresenter;
	...
	{
		$service = new App\UI\Home\HomePresenter($this->getService('03'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__3(): App\UI\Test\TestPresenter
	{
		$service = new App\UI\Test\TestPresenter($this->getService('02'), $this->getService('03'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__6(): App\UI\Error\Error5xx\Error5xxPresenter
	{
		return new App\UI\Error\Error5xx\Error5xxPresenter($this->getService('tracy.logger'));
	}


	public function createServiceApplication__7(): App\UI\Error\Error4xx\Error4xxPresenter
	{
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/var/www/mp/temp/cache/nette.application/touch'));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('/var/www/mp/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('/var/www/mp/temp/cache', $this->getService('cache.journal'));
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_324aa490d8 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/var/www/mp/temp/cache/latte');
