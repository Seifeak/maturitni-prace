...
final class Template_ac13fc18e5 extends Latte\Runtime\Template
{
	...
	public function prepare(): array
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === 'extends') {
			foreach (array_intersect_key(['book' => '119'], $this->params) as $ʟ_v => $ʟ_l) {
...
';
        ...
        <div class="container h-100">
            <div class="row h-100">
                <div class="col-auto col-lg-8 text-center justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                    <div>
                        <h2 class="text-uppercase fw-bold mb-3" style="font-size: 50px;margin-top: 16px;">Objev svět
                            knih!</h2>
                        <p class="mb-4" style="font-size: 18px;"><br>Zadej název knihy nebo jméno autora a najdi svou
                            další četbu.<br><br></p>
                    </div>
                    <div>
                        <form action="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Results:default', ['query' => '', 'filter' => ''])) /* line 29 */;
		echo '" method="GET"
                              style="display: flex;"><input class="form-control" type="search" name="query"
                                                            placeholder="Hledat"
                                                            style="height: 60px;border-bottom-right-radius: 0px;border-top-right-radius: 0px;border-top-left-radius: 8px;border-bottom-left-radius: 8px;width: 100%;border-style: solid;border-right-style: none;"
                                                            required><select name="filter" class="form-select"
                                                                             style="border-radius: 0;width: auto;text-align: left;border-right-style: none;border-left-style: none;">
        ...
        <div class="container py-4 py-xl-5">
            <div class="row gy-4 row-cols-2 row-cols-md-4">
                <div class="col">
                    <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                        <div class="bs-icon-xl bs-icon-circle bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block mb-2 bs-icon lg"
                             style="background: radial-gradient(#110077, #16009d);"><i class="fas fa-book"></i></div>
                        <div class="px-3">
                ...
                <div class="col">
                    <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                        <div class="bs-icon-xl bs-icon-circle bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block mb-2 bs-icon lg"
                             style="background: radial-gradient(#110077, #16009d);">
                ...
                <div class="col">
                    <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                        <div class="bs-icon-xl bs-icon-circle bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block mb-2 bs-icon lg"
                             style="background: radial-gradient(#110077, #16009d);"><i class="fa fa-language"></i></div>
                        <div class="px-3">
                ...
                <div class="col">
                    <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                        <div class="bs-icon-xl bs-icon-circle bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block mb-2 bs-icon lg"
                             style="background: radial-gradient(#110077, #16009d);"><i class="material-icons"
                                                                                       style="font-size: 42px;">movie</i>
                        </div>
                        <div class="px-3">
    ...
    <section class="books-selection-container">
        ...
        <div class="index-slider-container">
            <h1 style="padding-left: 40px;margin-bottom: 36px;">Nejoblíbenější knihy</h1>
            <div class="slider-container">
                ...
                <div class="slider-wrapper">
                    <div class="slider">
';
		foreach ($recommendedBooks as $book) /* line 119 */ {
			echo '                            <div class="book-card">
                                <a href="';
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Book:details', ['id' => $book['id']])) /* line 121 */;
			echo '" class="book_link">
                                    <div class="book-cover">
                                        <img
                                                src="';
			echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($book['cover'])) /* line 124 */;
			echo '"/>
                                    </div>
                                    <div class="book-title">';
			echo LR\Filters::escapeHtmlText($book['title']) /* line 126 */;
			echo '</div>
                                    <div class="book-author">';
			echo LR\Filters::escapeHtmlText($book['authors']) /* line 127 */;
			echo '</div>
                                </a>
                            </div>
';
